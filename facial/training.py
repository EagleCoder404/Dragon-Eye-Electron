...
while True:
    ...
    if(counter==0):
        ...
        playsound("facial/front.mp3")
    elif(counter==200):
        
        playsound("facial/right30.mp3")
    elif(counter==400):
        
        playsound("facial/right60.mp3")
    elif(counter==600):
        
        playsound("facial/left30.mp3")
    elif(counter==800):
        
        playsound("facial/left60.mp3")
    elif(counter==1000):
        
        playsound("facial/front30up.mp3")
    elif(counter==1200):
        
        playsound("facial/front30down.mp3")
    k=cv2.waitKey(1)
    if(k%256==27):
        break
    if(counter==1400):
    ...
    counter=counter+1
    cv2.imwrite('facial/database/abhilash/'+img_name,frame)
cam.release()
cv2.destroyAllWindows()
playsound("facial/message.mp3")
